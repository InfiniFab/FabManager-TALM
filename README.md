...
---
curl -L -o setup_fabmanager.sh https://raw.githubusercontent.com/InfiniFab/FabManager-TALM/main/scripts/setup_fabmanager.sh
chmod +x setup_fabmanager.sh
sudo ./setup_fabmanager.sh
